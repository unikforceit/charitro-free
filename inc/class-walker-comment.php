...
if (!class_exists('Charitro_Walker_Comment')) {
    /**
     * CUSTOM COMMENT WALKER
     * A custom walker for comments, based on the walker in Twenty Nineteen and Twenty Twenty.
     */
    class Charitro_Walker_Comment extends Walker_Comment
    {
                ...
                <div class="comment-content">
                    ...
                    if ('0' === $comment->comment_approved) {
                        ...
                        <p class="comment-awaiting-moderation">
                            <b><?php esc_html_e('Your comment has been successfully submitted and is awaiting moderation.', 'charitro'); ?></b>
                        </p>
                        <?php
                    }
                    ?>
